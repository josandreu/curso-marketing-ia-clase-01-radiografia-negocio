  ...
  return (
    <SlideShell className="flex flex-col justify-center px-8 md:px-16 overflow-hidden">
      <div className="max-w-5xl mx-auto w-full relative z-10 font-body">
        <p className="font-body text-sm tracking-[0.2em] uppercase text-primary mb-3 fade-up fade-up-1">Bloque 1 — Activación</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8 fade-up fade-up-3 opacity-60 grayscale-[50%]">
          <BentoCard className="flex items-center justify-center text-center py-8 relative">
             <span className="text-sm italic">"Somos una agencia de marketing..."</span>
             <div className="absolute top-1/2 left-4 right-4 h-0.5 bg-destructive/40 -translate-y-1/2 -rotate-2" />
          </BentoCard>
          <BentoCard className="flex items-center justify-center text-center py-8 relative">
             <span className="text-sm italic">"Ofrecemos consultoría integral..."</span>
             <div className="absolute top-1/2 left-4 right-4 h-0.5 bg-destructive/40 -translate-y-1/2 rotate-2" />
          </BentoCard>
          <BentoCard className="flex items-center justify-center text-center py-8 relative">
             <span className="text-sm italic">"Ayudamos a crecer..."</span>
        ...
        <div className="w-full flex items-center gap-6 my-8 fade-up fade-up-4">
          ...
          <span className="text-xs font-mono uppercase tracking-[0.3em] text-muted-foreground font-bold">vs</span>
          <div className="h-px bg-border flex-1" />
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 fade-up fade-up-6">
          ...
          <div className="col-span-3">
            <p className="text-lg text-muted-foreground leading-snug">
              ...
              <strong className="text-foreground font-800 tracking-tight">SIN TENER ESTA BASE.</strong>
            </p>
          </div>
        </div>
      </div>
