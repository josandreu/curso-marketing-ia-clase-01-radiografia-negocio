  ...
  return (
    <SlideShell className="flex flex-col justify-center px-8 md:px-16 overflow-hidden">
      <div className="max-w-6xl mx-auto w-full relative z-10 font-body">
        <p className="font-body text-sm tracking-[0.2em] uppercase text-primary mb-3 fade-up fade-up-1 text-center">Output — Análisis de competencia</p>
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-primary/5 border-b border-border/50">
                  <th className="p-6 font-heading text-[11px] font-900 uppercase tracking-widest text-primary/60">Competidor</th>
                  <th className="p-6 font-heading text-[11px] font-900 uppercase tracking-widest text-primary/60">Público</th>
                  <th className="p-6 font-heading text-[11px] font-900 uppercase tracking-widest text-primary/60">Propuesta</th>
                  <th className="p-6 font-heading text-[11px] font-900 uppercase tracking-widest text-primary/60">Canal</th>
                  <th className="p-6 font-heading text-[11px] font-900 uppercase tracking-widest text-primary/60">Oportunidad</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-border/40">
                {rows.map((row, i) => (
                  ...
                  >
                    <td className={`p-6 text-sm font-bold ${row.highlight ? 'text-primary' : 'text-foreground/80'}`}>
                       <div className="flex items-center gap-3">
                          {row.highlight && <div className="w-2 h-2 rounded-full bg-primary" />}
                          {row.name}
                       </div>
                    </td>
                    <td className="p-6 text-[13px] text-muted-foreground">{row.audience}</td>
                    <td className="p-6 text-[13px] text-muted-foreground">{row.value}</td>
                    <td className="p-6 text-[13px] text-muted-foreground">{row.channel}</td>
                    <td className={`p-6 text-[13px] ${row.highlight ? 'text-primary' : 'text-foreground/70 italic'}`}>
                        {row.gap}
                    </td>
                  </tr>
                ))}
        ...
        <p className="mt-8 text-center font-body text-sm text-muted-foreground italic fade-up fade-up-4">
