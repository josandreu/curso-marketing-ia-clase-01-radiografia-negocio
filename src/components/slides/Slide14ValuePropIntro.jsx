    ...
    <SlideShell className="flex items-center px-8 md:px-16 overflow-hidden">
      <div className="max-w-6xl mx-auto w-full grid grid-cols-1 lg:grid-cols-[1.2fr,1fr] gap-20 items-center font-body">
        <div className="flex-1">
          <p className="font-body text-sm tracking-[0.2em] uppercase text-primary mb-3 fade-up fade-up-1">Paso 4 — Herramienta 3</p>
          ...
          <div className="space-y-4 fade-up fade-up-4">
            <div className="flex items-center gap-5 p-4 bg-muted/30 rounded-2xl border border-border/50">
               <div className="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center font-bold text-primary">1</div>
               <p className="text-sm font-medium text-foreground/80">Input: Mapa de empatía + Benchmarking</p>
            </div>
            <div className="flex items-center gap-5 p-4 bg-muted/30 rounded-2xl border border-border/50">
               <div className="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center font-bold text-primary">2</div>
               <p className="text-sm font-medium text-foreground/80">Proceso: ChatGPT como Copywriter Estratégico</p>
            </div>
            <div className="flex items-center gap-5 p-4 bg-primary/5 rounded-2xl border border-primary/20">
               <div className="w-10 h-10 rounded-xl bg-white shadow-sm flex items-center justify-center font-bold text-primary">3</div>
               <p className="text-sm font-bold text-primary italic">Output: Propuesta de valor diferencial</p>
            </div>
          </div>
        </div>
